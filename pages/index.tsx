            ...
            <div className="grid grid-cols-3 grid-rows-2 gap-12">
              <div>
                ...
                <p>
                  ...
                  tellus mattis semper sed et ante. In non elit sit amet magna
                  tristique aliquam. Nulla quis pretium dui, ut tristique orci.
                  Donec eget odio eu metus accumsan ullamcorper eu in enim.
                  Curabitur sed velit pellentesque, placerat lacus nec, vehicula
                  magna.
                </p>
              </div>
              <div>
